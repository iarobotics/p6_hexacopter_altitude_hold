...
void loop(){  
  ...
  if(error == 0){
    ...
    Serial.print(F("Digital input 02 = "));
    Serial.println(receiver_input_channel_1);
    Serial.print(F("Digital input 04 = "));
    Serial.println(receiver_input_channel_2);
    Serial.print(F("Digital input 07 = "));
